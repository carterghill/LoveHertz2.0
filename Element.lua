  ...
  function ui:draw()
    ...
    elseif self.type == "Health Bar" or self.type == "health bar" then
      ...
      if l.players.health ~= 0 then
        ...
        love.graphics.rectangle("fill", self.x*globalScale, self.y*globalScale, (width_per_unit * l.players.health)*globalScale, self.height*globalScale, 5*globalScale, 5*globalScale)
        love.graphics.setColor(255, 255, 255, 255)
      end
